...
AFU=adif.py bandplan.py cty.py dbimport.py dxcc.py eqsl.py __init__.py \
    lotw.py qslcard.py qth.py requester.py
VERSIONPY=afu/Version.py
VERSION=$(VERSIONPY)
README=README.rst
SRC=Makefile setup.py $(AFU:%.py=afu/%.py) \
...
clean:
	rm -f MANIFEST afu/Version.py notes changes default.css    \
